    ...
    fetch('sensor-data/') // Đường dẫn tới API 
        ...
        .then(data => {
            ...
            console.log(data); 
                ...
                dps4.push({ x:  xVal , y: lastItem.dust });
                xVal += 2
            ...
            if (dps1.length > 0) {
                ...
                document.getElementById("value4").innerText = dps4[dps4.length - 1].y;
                ...
                changeBackgroundColor_dust2("value4", dps4[dps4.length - 1].y);
            }
        })
...
function changeBackgroundColor_dust2(elementId, value) {
